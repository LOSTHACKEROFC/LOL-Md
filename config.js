...
module.exports = {
    ...
    MENTION: process.env.TAG_REPLY === undefined ? '919536476115@s.whatsapp.net' : process.env.TAG_REPLY,
    ABU: process.env.NAME_STYLE === undefined ? '𝘾𝙃𝙄𝙍𝘼𝙂 𝙔𝙊𝙐𝙏𝙐𝘽𝙀𝙍' : process.env.NAME_STYLE,
    ...
    BOTABU: process.env.BOTV2_NAME === undefined ? '  𝘾𝙃𝙄𝙍𝘼𝙂 𝙔𝙊𝙐𝙏𝙐𝘽𝙀𝙍࿐  \n\n   *ωнαтsαρρ вσт™*   \n' : process.env.BOTV2_NAME,
    ...
    BOT: process.env.BOT_NAME === undefined ? '𝘾𝙃𝙄𝙍𝘼𝙂 𝙔𝙊𝙐𝙏𝙐𝘽𝙀𝙍࿐' : process.env.BOT_NAME,
    ...
    LOGO_NAME: process.env.ALL_NAME === undefined ? '𝘾𝙃𝙄𝙍𝘼𝙂 𝙔𝙊𝙐𝙏𝙐𝘽𝙀𝙍࿐' : process.env.ALL_NAME,
    ...
    SUDO: process.env.SUDO === undefined ? '919536476115' : process.env.SUDO,
    DEBUG: DEBUG,
    WITAI_API: "TEYMELA6DMC4XB5YM3SPTTQWUUIBKURG",
    SUPPORT: "919536476115-918650657221",
